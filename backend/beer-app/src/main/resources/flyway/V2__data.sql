...
INSERT INTO `payment_type` (`name`) VALUES ('Bank transfer');
INSERT INTO `payment_type` (`name`) VALUES ('Cash on delivery');

INSERT INTO `shipping` ( `name`, `price`, `delivery_time`) VALUES ('Pick up', 0, 0);
INSERT INTO `shipping` ( `name`, `price`, `delivery_time`) VALUES ('Deliver Service - 2 days', 100, 2);
