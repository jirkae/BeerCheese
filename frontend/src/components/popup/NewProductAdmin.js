...
export default class NewProductAdmin extends React.Component {
  ...
  onSubmit = (event) => {
    ...
    api.post('products', new FormData(event.target))
      .then(data => {
            ...
            <Row>
              <Form onSubmit={this.onSubmit}>
                ...
                <FormGroup row>
                  ...
                  <Col sm={8}>
                    <InputGroup>
                      <Input type="number" name="productPriceAfterDiscount" id="productPriceAfterDiscount"/>
                      <InputGroupAddon>Kč</InputGroupAddon>
                    </InputGroup>
                  </Col>
                </FormGroup>
                ...
                <FormGroup row>
                  ...
                  <Col sm={8}>
                    <InputGroup>
                      <Input type="number" name="productQuantity" id="productQuantity" defaultValue="0"/>
