  ...
  return mockProducts.map((product) => {
    return (
      <tr key={product.id}>
        ...
        <td>
          <Button onClick={() => openModal({name: 'editProductAdmin', data: product})}>
...
const AdminProductsPage = (props) => (
  <div>
    ...
    <Container>
      ...
      <Button onClick={() => props.openModal({name:'newProductAdmin',data:null})}>{localizedTexts.AdminProductsPage.btnAddProduct}</Button>
    </Container>
  </div>
);
